      ...
      <div class="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <div class="text-center mb-8">
          <div class="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 class="text-2xl font-semibold text-gray-900">RunTracker</h1>
          </div>
          <p class="text-gray-500 text-sm">{{ isRegister() ? 'Create your account' : 'Welcome back' }}</p>
        </div>
        ...
        <button (click)="auth.loginWithGoogle()"
          class="w-full border border-gray-300 text-gray-700 py-2 rounded-lg hover:bg-gray-50 flex items-center justify-center gap-3 font-medium">
